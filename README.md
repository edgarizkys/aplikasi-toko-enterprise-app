...
🏪 Sistem POS & Inventory Toko Enterprise - World-Class Enterprise v5.0
...
## Entities
- **Produk**: SKU, Nama Produk, Kategori, Harga (Rp), Stok Unit, Status
- **Penjualan / Transaksi**: No. Invoice, Pelanggan, Total (Rp), Metode Bayar, Tanggal
- **Supplier**: Nama Supplier, Kontak, Alamat, Kategori Produk
